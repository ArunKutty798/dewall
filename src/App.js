...
const connect = () => {
  const fm = new Fortmatic("pk_test_C268C897D0EB43E8");

  // window.web3 = new Web3(fm.getProvider());
  const provider = new ethers.providers.Web3Provider(fm.provider());
...
function App() {
  return (
    <View style={styles.app}>
      ...
      <Button onPress={() => connect()} title="Example button" />
    </View>
  );
}
